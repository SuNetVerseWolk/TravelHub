    ...
    <>
        <div className={styles.filterContainer}>
            <div>
                ...
                <p>Мы — ваша надежная путеводная звезда в мире путешествий! Наша цель — сделать ваши приключения незабываемыми, предлагая широкий спектр услуг, которые помогут вам открыть новые горизонты и насладиться каждой минутой вашего путешествия.</p>
